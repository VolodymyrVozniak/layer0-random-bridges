...
from ..bridges.utils import search_setting_data, transaction_verification
from ..bridges.settings import SETTING_BITCOINRIDGE_LIST
from .settings import TRADERJOE, TRADERJOE_ABI


def trade_avax_to_btc(name, private_key, value, max_gas):
    log_name = f'TRADERJOE AVAX to BTC.b'

    avalanche_data = search_setting_data(chain='Avalanche', list=SETTING_BITCOINRIDGE_LIST)
